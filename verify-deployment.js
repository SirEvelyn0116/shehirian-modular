...
async function verifyDeployment() {
  ...
  const checks = [
    ...
    { name: 'English page', url: `${BASE_URL}/en/index.html` },
    { name: 'French page', url: `${BASE_URL}/fr/index.html` },
    { name: 'Arabic page', url: `${BASE_URL}/ar/index.html` },
    { name: 'Armenian page', url: `${BASE_URL}/hy/index.html` },
    { name: 'Recipes index', url: `${BASE_URL}/en/recipes/index.html` },
    { name: 'BRC certification', url: `${BASE_URL}/en/certifications/brc.html` },
    { name: 'SQF certification', url: `${BASE_URL}/fr/certifications/sqf.html` },
    { name: 'IFS certification', url: `${BASE_URL}/ar/certifications/ifs.html` },
    { name: 'Shirag products', url: `${BASE_URL}/en/products/shirag.html` },
    { name: 'Mr. Falafel products', url: `${BASE_URL}/ar/products/mr-falafel.html` },
